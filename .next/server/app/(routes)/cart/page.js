...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7395)), "/Users/thanhtut/Projects/other/vercel/app/(routes)/cart/page.tsx"],
        ...
        {
          'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4166)), "/Users/thanhtut/Projects/other/vercel/app/(routes)/loading.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8861)), "/Users/thanhtut/Projects/other/vercel/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/thanhtut/Projects/other/vercel/app/(routes)/cart/page.tsx"];
    ...
    const originalPathname = "/(routes)/cart/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7493))
...
var use_cart = __webpack_require__(9506);
// EXTERNAL MODULE: ./node_modules/next/navigation.js
var navigation = __webpack_require__(9483);
// EXTERNAL MODULE: ./components/ui/button.tsx
var ui_button = __webpack_require__(8546);
// EXTERNAL MODULE: ./components/ui/currency.tsx
var currency = __webpack_require__(6285);
// EXTERNAL MODULE: ./node_modules/react-hot-toast/dist/index.mjs + 1 modules
var dist = __webpack_require__(3518);
;// CONCATENATED MODULE: ./app/(routes)/cart/components/summary.tsx
...
const Summary = ()=>{
    ...
    const items = (0,use_cart/* default */.Z)((state)=>state.items);
    const removeAll = (0,use_cart/* default */.Z)((state)=>state.removeAll);
    (0,react_.useEffect)(()=>{
        if (searchParams.get("success")) {
            dist.toast.success("Payment completed.");
            removeAll();
        }
        if (searchParams.get("canceled")) {
            dist.toast.error("Something went wrong.");
        }
    }, [
        searchParams,
        removeAll
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx(currency/* default */.Z, {
                            value: totalPrice
                        })
                    ]
                })
...
/* harmony default export */ const summary = (Summary);
...
;// CONCATENATED MODULE: ./components/ui/icon-button.tsx


const IconButton = ({ onClick, icon, className })=>{
    return /*#__PURE__*/ jsx_runtime_.jsx("button", {
        onClick: onClick,
        className: (0,utils.cn)("rounded-full flex items-center justify-center bg-white border shadow-md p-2 hover:scale-110 transition", className),
        children: icon
    });
};
/* harmony default export */ const icon_button = (IconButton);

;// CONCATENATED MODULE: ./app/(routes)/cart/components/cart-item.tsx
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(icon_button, {
                            onClick: onRemove,
                            icon: /*#__PURE__*/ jsx_runtime_.jsx(lucide_react.X, {
                                size: 15
                            })
                        })
                    }),
...
;// CONCATENATED MODULE: ./app/(routes)/cart/page.tsx
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    cart.items.length === 0 && /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                        className: "text-neutral-500",
                                        children: "No items added to cart."
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("ul", {
                                        children: cart.items.map((item)=>/*#__PURE__*/ jsx_runtime_.jsx(cart_item, {
                                                data: item
                                            }, item.id))
                                    })
                                ]
...
/* harmony default export */ const page = (CartPage);
...
/* harmony export */   revalidate: () => (/* binding */ e0)
/* harmony export */ });
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/thanhtut/Projects/other/vercel/app/(routes)/cart/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,212,886], () => (__webpack_exec__(849)));
